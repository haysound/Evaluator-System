...
$totalScore= $conn->query("SELECT totalScore FROM ratings where employee_id = '$staffNum' ");
$totalScore = $totalScore->num_rows > 0 ? $totalScore->fetch_array()['totalScore'] : 'Not Yet Evaluated';
}
?>
<!-- Print CSS stylesheet -->
<link rel="stylesheet" type="text/css" href="assets/dist/css/print.css" media="print">
      ...
      <div class="card-footer">
        <div class="container-fluid">
          ...
          <dl>
            ...
            <dd><?php echo ucwords($totalScore) ?></dd>
          </dl>
        </div>
    </div>
	</div>
...
<div class="modal-footer display p-0 m-0">
  <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        ...
        <button type="button" class="btn btn-secondary" onclick="printModal()" data-dismiss="modal">Print</button>
</div>
<style>
